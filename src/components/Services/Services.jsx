    ...
    return (
        <div>
            ...
            <Grid container className={cn(classes.root)}>
                ...
                <Grid item md={6} xs={12} sm={12} style={!matches ? { position: "relative", left: `-${setOffsetY * 0.1}px`, transition: "all 0.8s linear" } : {}}>
                ...
                <Grid item md={6} xs={12} sm={12} style={!matches ? { position: "relative", right: `-${setOffsetY * 0.1}px`, transition: "all 0.8s linear" } : {}} >
                ...
                <Grid item md={6} sm={12} xs={12} style={!matches ? { position: "relative", right: `-${setOffsetY * 0.1}px`, transition: "all 0.8s linear" } : {}}>
                    <Card style={card} elevation={0}>
                        <CardContent>
                            <div>
